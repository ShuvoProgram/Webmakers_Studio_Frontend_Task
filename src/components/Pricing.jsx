  ...
  return (
    ...
    <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
        <div className=" mx-auto mb-8 text-center lg:mb-12">
            <h2 className="mb-4 text-5xl font-bold tracking-tight text-gray-900 dark:text-white">Pricing made for collaborative support.</h2>
            <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Plain is made for your entire company. Only pay for users that actually message customers. Everyone else is free, forever.</p>
        </div>
